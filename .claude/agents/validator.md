...
- Completing any arch opens validation to the others: `awaiting-port` becomes `port-ready` once a port exists at head_sha. There is no lead -- whichever arch validated first simply established that there is something to validate.
