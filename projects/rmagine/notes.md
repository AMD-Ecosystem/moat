...
A dependency fork: the sensor-model library rmcl's correspondence search builds against.
...
The validation lives with **rmcl**, `completed` on linux-gfx1100, linux-gfx90a, windows-gfx1101, windows-gfx1201.
