...
3. **MinGW import libraries for HIP DLLs**
   ...
   - Created MinGW import libraries from DLLs:
     ...
     ```
   - Stored in `C:\Users\<user>\AppData\Local\Temp\mingw_libs\`.
...
set CGO_LDFLAGS=-LC:\Users\<user>\AppData\Local\Temp\mingw_libs -lamdhip64 -lhipfft -lhiprand
set GOFLAGS=-mod=mod
...
CGO_LDFLAGS=-LC:\Users\<user>\AppData\Local\Temp\mingw_libs -lamdhip64 -lhipfft -lhiprand
...
export CGO_LDFLAGS="-LC:/Users/<user>/AppData/Local/Temp/mingw_libs -lamdhip64 -lhipfft -lhiprand"
...
MinGW import libraries (.dll.a) created via gendef+dlltool, stored at C:/Users/<user>/AppData/Local/Temp/mingw_libs/. Build uses CGO_LDFLAGS=-L<that dir>.
